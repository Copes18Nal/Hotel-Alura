...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblTitulo.setBounds(96, 67, 240, 42);
		...
		lblFechaIngreso.setForeground(SystemColor.textInactiveText);
		lblFechaIngreso.setFont(new Font("Dialog", Font.PLAIN, 20));
		lblFechaIngreso.setBounds(68, 120, 219, 42);
		panel.add(lblFechaIngreso);
		
		JLabel lblFechaSalida = new JLabel("Fecha salida");
		lblFechaSalida.setForeground(SystemColor.textInactiveText);
		lblFechaSalida.setFont(new Font("Dialog", Font.PLAIN, 20));
		lblFechaSalida.setBounds(68, 204, 219, 42);
		panel.add(lblFechaSalida);
	}

	private void guardarReserva() {
		if (txtFechaE.getDate() != null && txtFechaS.getDate() != null && !txtValor.equals("") && !txtFormaPago.getSelectedItem().toString().equals("")) {
	...
	private void calcularValor(JDateChooser dateE, JDateChooser dateS) {
